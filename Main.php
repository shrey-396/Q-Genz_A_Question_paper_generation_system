  ...
  <div class='container'>
    ...
    <div class="row">
      ...
      <div class="col-8">
       ...
       <p>User ID: <?php echo $uinfo['id']; ?> <br/>User Since: <?php echo $uinfo['created_at']; ?><br/><br/>
        <!--Available permission: <br/>================<br/> Add Questions:
        <?php if($uinfo['isTeacher']=="1") echo "YES"; else echo "NO";  ?> | Generate Paper: <?php if($uinfo['isAdmin']=="1") echo "YES"; else echo "NO"; ?> | Download Permission: <?php if($uinfo['isFetcher']=="1") echo "YES"; else echo "NO"; ?>-->
      </p>
